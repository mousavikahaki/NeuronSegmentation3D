...
Original file is located at
    https://colab.research.google.com/drive/1ksSxHwNXV_ArUiUAGugZJV97W9urXg_d
"""
...
ids = next(os.walk("/content/drive/My Drive/Colab Notebooks/Data/L1"))[2] # list of names all images in the given path
...
for n, id_ in tqdm_notebook(enumerate(ids), total=len(ids)):
    # Load images
    img = load_img("/content/drive/My Drive/Colab Notebooks/Data/L1/"+id_, grayscale=True)
    x_img = img_to_array(img)
    x_img = resize(x_img, (512, 512, 1), mode = 'constant', preserve_range = True)
    # Load masks
    mask = img_to_array(load_img("/content/drive/My Drive/Colab Notebooks/Data/L1M/"+id_, grayscale=True))
...
results = model.fit(X_train, y_train, batch_size=32, epochs=10000, callbacks=callbacks,\
